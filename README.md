...
### Go the the [wiki](https://github.com/pereiramemo/AGS-and-ACN-tools/wiki) page to find the documentation, more in detail installation instructions, and a getting started tutorial.